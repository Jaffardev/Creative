...
[Table("pur_treasury")]
public partial class PurTreasury
{
    [Key]
    ...
    [Column("acc_commission_id", TypeName = "decimal(18, 0)")]
    public decimal? AccCommissionId { get; set; }
    ...
    [Column("commission_ratio", TypeName = "decimal(18, 5)")]
