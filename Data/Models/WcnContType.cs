...
[Table("wcn_cont_type")]
public partial class WcnContType
{
    [Key]
    ...
    [Column("discount_cost_id", TypeName = "decimal(18, 0)")]
    public decimal? DiscountCostId { get; set; }

    [Column("discount_exp_id", TypeName = "decimal(18, 0)")]
    public decimal? DiscountExpId { get; set; }

    [Column("discount_analysis_id", TypeName = "decimal(18, 0)")]
    public decimal? DiscountAnalysisId { get; set; }
}
