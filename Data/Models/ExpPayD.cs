...
public partial class ExpPayD
{
    ...
    [Column("amont_test", TypeName = "decimal(18, 0)")]
    public decimal? AmontTest { get; set; }
    ...
    [ForeignKey("HId")]
    [InverseProperty("ExpPayDs")]
    public virtual ExpPayH? HIdNavigation { get; set; }

    [ForeignKey("StudentId")]
    [InverseProperty("ExpPayDs")]
    public virtual RegStudent? Student { get; set; }
}
