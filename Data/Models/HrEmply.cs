...
public partial class HrEmply
{
    ...
    [Column("nationalty_id", TypeName = "decimal(18, 0)")]
    public decimal? NationaltyId { get; set; }

    [Column("regonal_id", TypeName = "decimal(18, 0)")]
    ...
    [Column("Work_time", TypeName = "decimal(18, 4)")]
    public decimal? WorkTime { get; set; }

    [Column("Legal_salary", TypeName = "decimal(18, 4)")]
    ...
    [Column("Experience_no", TypeName = "decimal(18, 0)")]
    public decimal? ExperienceNo { get; set; }

    [Column("Experience_in_kw", TypeName = "decimal(18, 0)")]
    public decimal? ExperienceInKw { get; set; }

    [Column("Experience_our_kw", TypeName = "decimal(18, 0)")]
    public decimal? ExperienceOurKw { get; set; }

    [Column("Experience_in_filed", TypeName = "decimal(18, 0)")]
    ...
    [Column("Stage_id_approved", TypeName = "decimal(18, 0)")]
    ...
    [Column("budget_salary_1", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalary1 { get; set; }

    [Column("budget_salary_2", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalary2 { get; set; }

    [Column("budget_salary_3", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalary3 { get; set; }

    [Column("budget_salary_4", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalary4 { get; set; }

    [Column("budget_salary_5", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalary5 { get; set; }

    [Column("budget_experiance", TypeName = "decimal(18, 5)")]
    public decimal? BudgetExperiance { get; set; }

    [Column("budget_salary_basic", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalaryBasic { get; set; }

    [Column("budget_salary_experiance", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalaryExperiance { get; set; }

    [Column("budget_salary_yearly", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalaryYearly { get; set; }

    [Column("budget_salary_lang", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalaryLang { get; set; }

    [Column("budget_salary_admin", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalaryAdmin { get; set; }

    [Column("budget_salary_alwnc", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalaryAlwnc { get; set; }

    [Column("budget_salary_extra", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalaryExtra { get; set; }

    [Column("budget_salary_total", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalaryTotal { get; set; }

    [Column("budget_salary_other", TypeName = "decimal(18, 5)")]
    ...
    [Column("old_salary", TypeName = "decimal(18, 5)")]
    public decimal? OldSalary { get; set; }

    [Column("atd_calendar_id", TypeName = "decimal(18, 0)")]
    ...
    [Column("degree_id", TypeName = "decimal(18, 0)")]
    public decimal? DegreeId { get; set; }

    [Column("budget_salary_6", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalary6 { get; set; }

    [Column("budget_salary_7", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalary7 { get; set; }

    [Column("budget_salary_8", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalary8 { get; set; }

    [Column("budget_salary_9", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalary9 { get; set; }

    [Column("budget_salary_10", TypeName = "decimal(18, 5)")]
    ...
    [Column("hrf_emp_id", TypeName = "decimal(18, 0)")]
    ...
    [Column("sick_fifth_leave", TypeName = "decimal(18, 3)")]
    public decimal? SickFifthLeave { get; set; }

    [Column("sick_sixth_leave", TypeName = "decimal(18, 3)")]
    public decimal? SickSixthLeave { get; set; }

    [Column("tamenat_amount_1", TypeName = "decimal(18, 3)")]
    public decimal? TamenatAmount1 { get; set; }

    [Column("tamenat_amount_2", TypeName = "decimal(18, 3)")]
    public decimal? TamenatAmount2 { get; set; }

    [Column("allow_kader", TypeName = "decimal(18, 4)")]
    public decimal? AllowKader { get; set; }

    [Column("allow_kids", TypeName = "decimal(18, 4)")]
    public decimal? AllowKids { get; set; }

    [Column("bouns", TypeName = "decimal(18, 4)")]
    ...
    [Column("icdl", TypeName = "decimal(18, 0)")]
    public decimal? Icdl { get; set; }

    [Column("budget_salary_11", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalary11 { get; set; }

    [Column("budget_salary_12", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalary12 { get; set; }

    [Column("budget_salary_13", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalary13 { get; set; }

    [Column("budget_salary_14", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalary14 { get; set; }

    [Column("budget_salary_15", TypeName = "decimal(18, 5)")]
    public decimal? BudgetSalary15 { get; set; }

    [Column("Indemity_scnd", TypeName = "decimal(18, 5)")]
    public decimal? IndemityScnd { get; set; }
}
