...
[Table("reg_responsibile")]
[Index("Code", Name = "IX_reg_responsibile", IsUnique = true)]
public partial class RegResponsibile
{
    [Key]
    ...
    [Column("child_no", TypeName = "decimal(18, 0)")]
    public decimal? ChildNo { get; set; }

    [InverseProperty("Responsibile")]
    public virtual ICollection<ExpPayH> ExpPayHs { get; set; } = new List<ExpPayH>();
}
