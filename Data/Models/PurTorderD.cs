...
[Table("pur_torder_d")]
public partial class PurTorderD
{
    [Key]
    ...
    [Column("discount_rate_1", TypeName = "decimal(18, 5)")]
    public decimal? DiscountRate1 { get; set; }

    [Column("discount_rate_2", TypeName = "decimal(18, 5)")]
    public decimal? DiscountRate2 { get; set; }

    [Column("discount_rate_3", TypeName = "decimal(18, 5)")]
