...
[Table("hsp_insurance_company")]
public partial class HspInsuranceCompany
{
    [Key]
    ...
    [Column("spatia_discount", TypeName = "decimal(18, 3)")]
    public decimal? SpatiaDiscount { get; set; }

    [Column("credit_limit", TypeName = "decimal(18, 3)")]
    ...
    [Column("insurance_discount1", TypeName = "decimal(18, 3)")]
    public decimal? InsuranceDiscount1 { get; set; }

    [Column("vip_ratio", TypeName = "decimal(18, 3)")]
