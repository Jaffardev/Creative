...
public partial class TtbTran
{
    ...
    [Column("teacher_id_1", TypeName = "decimal(18, 0)")]
    public decimal? TeacherId1 { get; set; }

    [Column("teacher_id_2", TypeName = "decimal(18, 0)")]
    public decimal? TeacherId2 { get; set; }

    [Column("teacher_id_3", TypeName = "decimal(18, 0)")]
    public decimal? TeacherId3 { get; set; }
